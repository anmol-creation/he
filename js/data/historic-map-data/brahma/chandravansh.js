export const chandravanshData = [
    ...
    { id: 'kshatravriddha_chandra', name: 'क्षत्रवृद्ध', subtitle: 'आयु के पुत्र', gender: 'male', parent: 'ayu_chandra', mother: 'prabha_chandra', yug: 'satya' },
    { id: 'sunahotra_kashi_chandra', name: 'सुनहोत्र', subtitle: 'क्षत्रवृद्ध पुत्र', gender: 'male', parent: 'kshatravriddha_chandra', yug: 'satya' },
    { id: 'kusha_vansh_proxy', name: 'कुश वंश', subtitle: 'कुश के वंशज', isProxy: true, parent: 'sunahotra_kashi_chandra', clusterName: 'कुश वंश', yug: 'satya' },
    { id: 'kusha_chandra', name: 'कुश', subtitle: 'सुनहोत्र पुत्र', gender: 'male', parent: 'kusha_vansh_proxy', yug: 'satya', clusterName: 'कुश वंश' },
    { id: 'prati_kusha_chandra', name: 'प्रति', subtitle: 'कुश पुत्र', gender: 'male', parent: 'kusha_chandra', yug: 'satya', clusterName: 'कुश वंश' },
    { id: 'sanjaya_kusha_chandra', name: 'सञ्जय', subtitle: 'प्रति पुत्र', gender: 'male', parent: 'prati_kusha_chandra', yug: 'satya', clusterName: 'कुश वंश' },
    { id: 'jaya_kusha_chandra', name: 'जय', subtitle: 'सञ्जय पुत्र', gender: 'male', parent: 'sanjaya_kusha_chandra', yug: 'satya', clusterName: 'कुश वंश' },
    { id: 'krita_kusha_chandra', name: 'कृत', subtitle: 'जय पुत्र', gender: 'male', parent: 'jaya_kusha_chandra', yug: 'satya', clusterName: 'कुश वंश' },
    { id: 'haryavana_chandra', name: 'हर्यवन (हर्यश्व)', subtitle: 'कृत पुत्र', gender: 'male', parent: 'krita_kusha_chandra', yug: 'treta', clusterName: 'कुश वंश' },
    { id: 'sahadeva_kusha_chandra', name: 'सहदेव', subtitle: 'हर्यवन पुत्र', gender: 'male', parent: 'haryavana_chandra', yug: 'treta', clusterName: 'कुश वंश' },
    { id: 'hina_chandra', name: 'हीन', subtitle: 'सहदेव पुत्र', gender: 'male', parent: 'sahadeva_kusha_chandra', yug: 'treta', clusterName: 'कुश वंश' },
    { id: 'jayasena_kusha_chandra', name: 'जयसेन', subtitle: 'हीन पुत्र', gender: 'male', parent: 'hina_chandra', yug: 'treta', clusterName: 'कुश वंश' },
    { id: 'sankriti_kusha_chandra', name: 'सङ्कृति', subtitle: 'जयसेन पुत्र', gender: 'male', parent: 'jayasena_kusha_chandra', yug: 'treta', clusterName: 'कुश वंश' },
    { id: 'jaya_sankriti_chandra', name: 'जय (क्षात्रधर्मा)', subtitle: 'सङ्कृति पुत्र', gender: 'male', parent: 'sankriti_kusha_chandra', yug: 'treta', clusterName: 'कुश वंश', parichay: 'यह महान महारथी थे, जिन्होंने क्षत्रियों के धर्म का पूरी निष्ठा से पालन किया।' },


    // --- काशी राजवंश (Kashi Dynasty) ---
    { id: 'kashi_dynasty_proxy', name: 'काशी राजवंश', subtitle: 'काश्य और उनके वंशज', isProxy: true, parent: 'sunahotra_kashi_chandra', clusterName: 'काशी राजवंश' },
    { id: 'kashya', name: 'काश्य', subtitle: 'काशी के संस्थापक', gender: 'male', parent: 'sunahotra_kashi_chandra', yug: 'satya', clusterName: 'काशी राजवंश', parichay: 'इन्हीं के नाम पर काशी (वाराणसी) नगर का नामकरण हुआ माना जाता है।' },
    ...
    { id: 'dhanvantari_chandra', name: 'धन्वंतरि', subtitle: 'आयुर्वेद प्रवर्तक / विष्णु अंशावतार', gender: 'male', parent: 'dirghatapa_chandra', yug: 'satya', clusterName: 'काशी राजवंश', parichay: 'समुद्र मंथन से अमृत कलश लेकर प्रकट हुए थे। काशी राजवंश में इनका जन्म हुआ था और ये महान वैद्य माने जाते हैं।' },
    ...
    { id: 'divodasa_chandra', name: 'दिवोदास', subtitle: 'काशी नरेश', gender: 'male', parent: 'bhimaratha_chandra', yug: 'treta', clusterName: 'काशी राजवंश', parichay: 'काशी के महान राजा, जिन्होंने क्षेमक राक्षस से काशी को मुक्त कराया था।' },
    { id: 'pratardana_chandra', name: 'प्रतर्दन', subtitle: 'दिवोदास पुत्र (ऋतध्वज)', gender: 'male', parent: 'divodasa_chandra', yug: 'treta', clusterName: 'काशी राजवंश', parichay: 'इन्हें ऋतध्वज भी कहा जाता है। इन्होंने पातालकेतु राक्षस का वध कर मदालसा से विवाह किया।' },
    ...
    { id: 'vikranta_chandra', name: 'विक्रान्त', subtitle: 'प्रतर्दन-मदालसा पुत्र', gender: 'male', parent: 'pratardana_chandra', mother: 'madalasa_chandra', yug: 'treta', clusterName: 'काशी राजवंश', parichay: 'मदालसा के ज्ञान उपदेश से यह बचपन में ही ब्रह्मज्ञानी (संन्यासी) हो गए।' },
    { id: 'subahu_kashi_chandra', name: 'सुबाहु', subtitle: 'प्रतर्दन-मदालसा पुत्र', gender: 'male', parent: 'pratardana_chandra', mother: 'madalasa_chandra', yug: 'treta', clusterName: 'काशी राजवंश', parichay: 'मदालसा के ज्ञान उपदेश से यह बचपन में ही ब्रह्मज्ञानी हो गए।' },
    { id: 'arimardana_chandra', name: 'अरि मर्दन', subtitle: 'प्रतर्दन-मदालसा पुत्र', gender: 'male', parent: 'pratardana_chandra', mother: 'madalasa_chandra', yug: 'treta', clusterName: 'काशी राजवंश', parichay: 'मदालसा के ज्ञान उपदेश से यह बचपन में ही ब्रह्मज्ञानी हो गए।' },

    { id: 'vatsa_kashi_chandra', name: 'वत्स', subtitle: 'प्रतर्दन पुत्र', gender: 'male', parent: 'pratardana_chandra', yug: 'treta', clusterName: 'काशी राजवंश' },
    { id: 'alarka_chandra', name: 'अलर्क', subtitle: 'काशी नरेश', gender: 'male', parent: 'vatsa_kashi_chandra', mother: 'madalasa_chandra', yug: 'treta', clusterName: 'काशी राजवंश', parichay: 'महान तपस्वी राजा जिसने 66,000 वर्ष तक राज किया और फिर दत्तात्रेय से ज्ञान प्राप्त कर मोक्ष पाया। यह मदालसा के सबसे छोटे पुत्र थे, जिन्हें राजधर्म की शिक्षा मिली थी।' },

    { id: 'sannati_kashi_chandra', name: 'सन्नति', subtitle: 'अलर्क पुत्र', gender: 'male', parent: 'alarka_chandra', yug: 'treta', clusterName: 'काशी राजवंश' },
    { id: 'sunitha_kashi_chandra', name: 'सुनीथ', subtitle: 'सन्नति पुत्र', gender: 'male', parent: 'sannati_kashi_chandra', yug: 'treta', clusterName: 'काशी राजवंश' },
    { id: 'suketu_kashi_chandra', name: 'सुकेतु', subtitle: 'सुनीथ पुत्र', gender: 'male', parent: 'sunitha_kashi_chandra', yug: 'treta', clusterName: 'काशी राजवंश' },
    { id: 'satyaketu_kashi_chandra', name: 'सत्यकेतु', subtitle: 'सुकेतु पुत्र', gender: 'male', parent: 'suketu_kashi_chandra', yug: 'treta', clusterName: 'काशी राजवंश' },
    { id: 'dhrishtaketu_kashi_chandra', name: 'धृष्टकेतु', subtitle: 'सत्यकेतु पुत्र', gender: 'male', parent: 'satyaketu_kashi_chandra', yug: 'treta', clusterName: 'काशी राजवंश' },
    { id: 'sukumara_kashi_chandra', name: 'सुकुमार', subtitle: 'धृष्टकेतु पुत्र', gender: 'male', parent: 'dhrishtaketu_kashi_chandra', yug: 'treta', clusterName: 'काशी राजवंश' },
    { id: 'vitihotra_kashi_chandra', name: 'वीतिहोत्र', subtitle: 'सुकुमार पुत्र', gender: 'male', parent: 'sukumara_kashi_chandra', yug: 'treta', clusterName: 'काशी राजवंश' },
    { id: 'bharga_kashi_chandra', name: 'भर्ग', subtitle: 'वीतिहोत्र पुत्र', gender: 'male', parent: 'vitihotra_kashi_chandra', yug: 'treta', clusterName: 'काशी राजवंश' },
    { id: 'bhargabhumi_chandra', name: 'भार्गभूमि', subtitle: 'भर्ग पुत्र', gender: 'male', parent: 'bharga_kashi_chandra', yug: 'treta', clusterName: 'काशी राजवंश', parichay: 'भर्ग से भार्गभूमि हुए। इन्हीं के वंशज आगे चलकर भार्गव (वत्स) कहलाए।' },


    { id: 'rambha_ayu_chandra', name: 'रम्भ', subtitle: 'आयु के पुत्र', gender: 'male', parent: 'ayu_chandra', mother: 'prabha_chandra', yug: 'satya' },
    { id: 'rambha_vansh_proxy', name: 'रम्भ वंश', subtitle: 'रम्भ के वंशज', isProxy: true, parent: 'rambha_ayu_chandra', clusterName: 'रम्भ वंश', yug: 'satya' },
    { id: 'rabhasa_chandra', name: 'रभस', subtitle: 'रम्भ पुत्र', gender: 'male', parent: 'rambha_vansh_proxy', yug: 'satya', clusterName: 'रम्भ वंश' },
    { id: 'gambhira_chandra', name: 'गम्भीर', subtitle: 'रभस पुत्र', gender: 'male', parent: 'rabhasa_chandra', yug: 'satya', clusterName: 'रम्भ वंश' },
    { id: 'akriya_chandra', name: 'अक्रिय', subtitle: 'गम्भीर पुत्र', gender: 'male', parent: 'gambhira_chandra', yug: 'satya', clusterName: 'रम्भ वंश', parichay: 'भागवत पुराण (9.17.10-11) के अनुसार, इनकी पत्नी के माध्यम से ब्राह्मणों के एक विशिष्ट वंश का आरंभ हुआ। क्षत्रिय राजा होने के बावजूद इनके वंशज ब्रह्मर्षि पद को प्राप्त हुए।' },
    { id: 'raji_chandra', name: 'रजि', subtitle: 'आयु के पुत्र', gender: 'male', parent: 'ayu_chandra', mother: 'prabha_chandra', yug: 'satya' },
    ...
    { id: 'anena_chandra', name: 'अनेना', subtitle: 'आयु के पुत्र', gender: 'male', parent: 'ayu_chandra', mother: 'prabha_chandra', yug: 'satya' },
    { id: 'anena_vansh_proxy', name: 'अनेना वंश', subtitle: 'अनेना के वंशज', isProxy: true, parent: 'anena_chandra', clusterName: 'अनेना वंश', yug: 'satya' },
    ...
    { id: 'shantaraya_chandra', name: 'शान्तरय', subtitle: 'त्रिककुद् पुत्र', gender: 'male', parent: 'trikakud_chandra', yug: 'satya', clusterName: 'अनेना वंश', parichay: 'ये आत्मज्ञानी (ब्रह्मज्ञानी) थे, अतः इन्होंने अपना वंश आगे नहीं बढ़ाया।' },
    ...
    { id: 'nahusha_sons_proxy', name: 'नहुष के अन्य पुत्र', subtitle: 'ययाति के अतिरिक्त ५ पुत्र', isProxy: true, parent: 'nahusha_chandra', clusterName: 'नहुष के पुत्र', yug: 'satya' },
    { id: 'yati_chandra', name: 'यति', subtitle: 'नहुष के ज्येष्ठ पुत्र', gender: 'male', parent: 'nahusha_chandra', mother: 'ashokasundari_chandra', yug: 'satya' , clusterName: 'नहुष के पुत्र', parichay: 'नहुष के ज्येष्ठ पुत्र। यति बचपन से ही आत्मज्ञानी थे और राज्यपद प्राप्त करने से मोक्ष में बाधा उत्पन्न होगी ऐसा सोचकर उन्होंने संन्यास ग्रहण कर लिया था।' },
    ...
    { id: 'somapi_chandra', name: 'सोमाधि/सोमापी', subtitle: 'सहदेव पुत्र', parent: 'sahadeva_magadh', yug: 'kali' },
    { id: 'shrutashravas_magadh', name: 'श्रुतश्रवस्', subtitle: 'सोमाधि पुत्र', parent: 'somapi_chandra', yug: 'kali' },
    { id: 'ayutayu_magadh', name: 'अयुतायु', subtitle: 'श्रुतश्रवस् पुत्र', parent: 'shrutashravas_magadh', yug: 'kali' },
    { id: 'niramitra_magadh', name: 'निरमित्र', subtitle: 'अयुतायु पुत्र', parent: 'ayutayu_magadh', yug: 'kali' },
    { id: 'sukshatra_magadh', name: 'सुक्षत्र', subtitle: 'निरमित्र पुत्र', parent: 'niramitra_magadh', yug: 'kali' },
    { id: 'brihatkarman_magadh', name: 'बृहत्कर्मन', subtitle: 'सुक्षत्र पुत्र', parent: 'sukshatra_magadh', yug: 'kali' },
    { id: 'senajit_magadh', name: 'सेनजित', subtitle: 'बृहत्कर्मन पुत्र', parent: 'brihatkarman_magadh', yug: 'kali' },
    { id: 'shrutanjaya_magadh', name: 'श्रुतंजय', subtitle: 'सेनजित पुत्र', parent: 'senajit_magadh', yug: 'kali' },
    { id: 'vipra_magadh', name: 'विप्र', subtitle: 'श्रुतंजय पुत्र', parent: 'shrutanjaya_magadh', yug: 'kali' },
    { id: 'shuchi_magadh', name: 'शुचि', subtitle: 'विप्र पुत्र', parent: 'vipra_magadh', yug: 'kali' },
    { id: 'kshemya_magadh', name: 'क्षेम्य', subtitle: 'शुचि पुत्र', parent: 'shuchi_magadh', yug: 'kali' },
    { id: 'suvrata_magadh', name: 'सुव्रत', subtitle: 'क्षेम्य पुत्र', parent: 'kshemya_magadh', yug: 'kali' },
    { id: 'dharma_magadh', name: 'धर्म', subtitle: 'सुव्रत पुत्र', parent: 'suvrata_magadh', yug: 'kali' },
    { id: 'sushrama_magadh', name: 'सुश्रम', subtitle: 'धर्म पुत्र', parent: 'dharma_magadh', yug: 'kali' },
    { id: 'dridhasena_magadh', name: 'दृढसेन', subtitle: 'सुश्रम पुत्र', parent: 'sushrama_magadh', yug: 'kali' },
    { id: 'sumati_magadh', name: 'सुमति', subtitle: 'दृढसेन पुत्र', parent: 'dridhasena_magadh', yug: 'kali' },
    { id: 'subala_magadh', name: 'सुबल', subtitle: 'सुमति पुत्र', parent: 'sumati_magadh', yug: 'kali' },
    { id: 'sunita_magadh', name: 'सुनीत', subtitle: 'सुबल पुत्र', parent: 'subala_magadh', yug: 'kali' },
    { id: 'satyajit_magadh', name: 'सत्यजित', subtitle: 'सुनीत पुत्र', parent: 'sunita_magadh', yug: 'kali' },
    { id: 'vishwajit_magadh', name: 'विश्वजित', subtitle: 'सत्यजित पुत्र', parent: 'satyajit_magadh', yug: 'kali' },
    { id: 'ripunjaya_magadh', name: 'रिपुंजय', subtitle: 'विश्वजित पुत्र', parent: 'vishwajit_magadh', yug: 'kali', parichay: 'बृहद्रथ वंश का अंतिम राजा, जिसे उसके मंत्री मुनिक/पुनिक ने मारकर प्रद्योत वंश की स्थापना की।' },
    ...
    { id: 'amba_chandra', name: 'अम्बा', subtitle: 'काशी पुत्री', gender: 'female', parent: 'kashya', yug: 'dwapar', clusterName: 'काशी राजवंश', parichay: 'काशी नरेश की सबसे बड़ी पुत्री। भीष्म द्वारा अपहरण के बाद इन्होने भीष्म से विवाह का आग्रह किया, परंतु उनके ब्रह्मचर्य व्रत के कारण अस्वीकार कर दी गईं। बाद में इन्होने शिखंडी के रूप में जन्म लिया।' },
    { id: 'ambika_chandra', name: 'अम्बिका', subtitle: 'काशी पुत्री / विचित्रवीर्य पत्नी', gender: 'female', parent: 'kashya', spouseOf: 'vichitravirya_chandra', yug: 'dwapar', clusterName: 'काशी राजवंश' },
    { id: 'ambalika_chandra', name: 'अम्बालिका', subtitle: 'काशी पुत्री / विचित्रवीर्य पत्नी', gender: 'female', parent: 'kashya', spouseOf: 'vichitravirya_chandra', yug: 'dwapar', clusterName: 'काशी राजवंश' },
