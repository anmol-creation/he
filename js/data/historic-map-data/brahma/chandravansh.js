export const chandravanshData = [
    ...
    // --- अत्रि के पुत्र ---
    { id: 'dattatreya_chandra', name: 'दत्तात्रेय', subtitle: 'विष्णु अंश', parent: 'atri', mother: 'anasuya_chandra', yug: 'satya' },
    { id: 'durvasa_chandra', name: 'दुर्वासा', subtitle: 'शिव अंश', parent: 'atri', mother: 'anasuya_chandra', yug: 'satya' },
    ...
    { id: 'shrutayu_chandra', name: 'श्रुतायु', subtitle: 'पुरुरवा के पुत्र', parent: 'pururava_chandra', mother: 'urvashi_chandra', yug: 'satya' },
    { id: 'satyayu_chandra', name: 'सत्यायु', subtitle: 'पुरुरवा के पुत्र', parent: 'pururava_chandra', mother: 'urvashi_chandra', yug: 'satya' },
    { id: 'raya_chandra', name: 'रय', subtitle: 'पुरुरवा के पुत्र', parent: 'pururava_chandra', mother: 'urvashi_chandra', yug: 'satya' },
    { id: 'vijaya_chandra', name: 'विजय', subtitle: 'पुरुरवा के पुत्र', parent: 'pururava_chandra', mother: 'urvashi_chandra', yug: 'satya' },
    { id: 'jaya_chandra', name: 'जय', subtitle: 'पुरुरवा के पुत्र', parent: 'pururava_chandra', mother: 'urvashi_chandra', yug: 'satya' },
    ...
    { id: 'haihaya_chandra', name: 'हैहय', subtitle: 'हैहय वंश के संस्थापक', parent: 'shatajit_haihaya', yug: 'treta' },
    ...
    { id: 'shurasen_chandra', name: 'शूरसेन (शूर)', subtitle: 'देवमीढुष पुत्र', parent: 'devamidhusha_vrishni', yug: 'dwapar' },
    { id: 'marisha_shurasen_chandra', name: 'मारिषा', subtitle: 'शूरसेन पत्नी', parent: '', spouseOf: 'shurasen_chandra', yug: 'dwapar' },

    // शूरसेन के पुत्र-पुत्रियां
    { id: 'vasudev_chandra', name: 'वसुदेव (आनकदुन्दुभि)', subtitle: 'कृष्ण के पिता', parent: 'shurasen_chandra', mother: 'marisha_shurasen_chandra', yug: 'dwapar' },
    { id: 'kunti_chandra', name: 'पृथा (कुंती)', subtitle: 'शूरसेन पुत्री', parent: 'shurasen_chandra', mother: 'marisha_shurasen_chandra', spouseOf: 'pandu_chandra', yug: 'dwapar', parichay: 'इन्हें कुंतीभोज ने गोद लिया था। इनका विवाह पांडु से हुआ।' },
    ...
    // वसुदेव की पत्नियां
    { id: 'rohini_vasudev_chandra', name: 'रोहिणी', subtitle: 'वसुदेव पत्नी', parent: '', spouseOf: 'vasudev_chandra', yug: 'dwapar', clusterName: 'वसुदेव की पत्नियाँ' },
    ...
    { id: 'krishna_chandra', name: 'कृष्ण (वासुदेव)', subtitle: 'पूर्णावतार', parent: 'vasudev_chandra', mother: 'devaki_devaka_chandra', yug: 'dwapar', parichay: 'भगवान विष्णु के पूर्णावतार। नन्द बाबा और यशोदा ने गोकुल में इनका पालन किया।' },
    ...
    { id: 'pradyumna_chandra', name: 'प्रद्युम्न', subtitle: 'कामदेव अवतार', parent: 'krishna_chandra', mother: 'rukmini_krishna_chandra', yug: 'dwapar' },
    ...
    { id: 'aniruddha_chandra', name: 'अनिरुद्ध', subtitle: 'प्रद्युम्न पुत्र', parent: 'pradyumna_chandra', mother: 'rukmavati_pradyumna_chandra', yug: 'dwapar' },
    ...
    { id: 'mangal_rao_bhati', name: 'मंगल राव', subtitle: 'भाटी नरेश', parent: 'bhatti_rao_chandra', yug: 'kali' },
    ...
    { id: 'lakho_jadani_chandra', name: 'लाखो जादाणी', subtitle: 'जाडेजा वंश के मूल', parent: 'mangal_rao_bhati', yug: 'kali', parichay: 'सिंध से कच्छ की ओर प्रवास किया। इन्हें जाडेजा (जादा के वंशज) कहा गया।' },
    { id: 'jam_raval_jadeja_chandra', name: 'जाम रावल', subtitle: 'नवानगर के संस्थापक', parent: 'lakho_jadani_chandra', yug: 'kali', parichay: '1540 ईस्वी में इन्होंने नवानगर (वर्तमान जामनगर) की स्थापना की।' },

    // --- जादौन राजवंश (बयाना / करौली) ---
    { id: 'vijaypala_jadon', name: 'विजयपाल', subtitle: 'बयाना के संस्थापक', parent: 'dharmapala_yaduvanshi_chandra', yug: 'kali', parichay: '1040 ईस्वी में बयाना (विजयमंदिरगढ़) पर राज किया। जादौन राजवंश के प्रमुख।' },
    ...
    { id: 'dridhaprahara_seuna', name: 'दृढप्रहार', subtitle: 'देवगिरि यादव संस्थापक', parent: 'yaduvansh_medieval_link_chandra', yug: 'kali', parichay: '9वीं सदी में सेउण राजवंश की नींव रखी।' },
    { id: 'seunachandra_chandra', name: 'सेउणचन्द्र', subtitle: 'देवगिरि यादव नरेश', parent: 'dridhaprahara_seuna', yug: 'kali' },
    { id: 'dhadiyappa_chandra', name: 'धाडियप्प', subtitle: 'देवगिरि यादव नरेश', parent: 'seunachandra_chandra', yug: 'kali' },
    ...
    { id: 'seunachandra_2_chandra', name: 'सेउणचन्द्र (द्वितीय)', subtitle: 'देवगिरि यादव नरेश', parent: 'vadugi_2_chandra', yug: 'kali' },
    { id: 'singhana_1_chandra', name: 'सिंघण (प्रथम)', subtitle: 'देवगिरि यादव नरेश', parent: 'seunachandra_2_chandra', yug: 'kali' },
    ...
    { id: 'krishna_seuna', name: 'कृष्ण (कान्हण)', subtitle: 'देवगिरि सम्राट', parent: 'singhana_2_chandra', yug: 'kali' },
    ...
    { id: 'parishrami_dasi_chandra', name: 'परिश्रमी (दासी)', subtitle: 'अम्बिका की दासी', parent: '', spouseOf: 'vyasa', yug: 'dwapar' },
    ...
    { id: 'dhritarashtra_chandra', name: 'धृतराष्ट्र', subtitle: 'हस्तिनापुर नरेश', parent: 'vyasa', mother: 'ambika_chandra', yug: 'dwapar', parichay: 'जन्मान्ध होने के कारण पाण्डु को राजा बनाया गया। ये कौरवों के पिता हैं (राजकीय पिता विचित्रवीर्य)।' },
    { id: 'pandu_chandra', name: 'पाण्डु', subtitle: 'पांडवों के पिता', parent: 'vyasa', mother: 'ambalika_chandra', yug: 'dwapar' },
    { id: 'vidur_chandra', name: 'विदुर', subtitle: 'धर्मराज अवतार', parent: 'vyasa', mother: 'parishrami_dasi_chandra', yug: 'dwapar' },
    ...
    { id: 'gandhari_chandra', name: 'गांधारी', subtitle: 'धृतराष्ट्र की पत्नी', parent: 'subala_gandhara', spouseOf: 'dhritarashtra_chandra', yug: 'dwapar' },
    ...
    { id: 'vikarna_chandra', name: 'विकर्ण', subtitle: 'कौरव (धर्मात्मा)', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar' },
    { id: 'yuyutsu_chandra', name: 'युयुत्सु', subtitle: 'धृतराष्ट्र पुत्र (दासी से)', parent: 'dhritarashtra_chandra', mother: 'vaishya_dasi_dhrita_chandra', yug: 'dwapar' },
    { id: 'dushala_chandra', name: 'दुश्शला', subtitle: 'कौरवों की इकलौती बहन', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', spouseOf: 'jayadratha', yug: 'dwapar' },

    // Injecting the 96 other Kauravas here
    { id: 'kaurava_0', name: 'दुर्मुख', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_1', name: 'दुस्सह', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_2', name: 'दुश्शल', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_3', name: 'जलसंध', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_4', name: 'सम', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_5', name: 'सह', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_6', name: 'विन्द', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_7', name: 'अनुविन्द', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_8', name: 'दुर्धर्ष', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_9', name: 'सुबाहु', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_10', name: 'दुष्प्रधर्षण', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_11', name: 'दुर्मर्षण', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_12', name: 'दुर्मुख (द्वितीय)', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_13', name: 'दुष्कर्ण', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_14', name: 'कर्ण', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_15', name: 'विविंशति', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_16', name: 'शल', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_17', name: 'सत्व', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_18', name: 'सुलोचन', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_19', name: 'चित्र', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_20', name: 'उपचित्र', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_21', name: 'चित्राक्ष', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_22', name: 'चारुचित्र', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_23', name: 'शरासन', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_24', name: 'दुर्मद', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_25', name: 'दुर्विगाह', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_26', name: 'विवित्सु', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_27', name: 'विकटानन्द', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_28', name: 'ऊर्णनाभ', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_29', name: 'सुनाभ', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_30', name: 'नन्द', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_31', name: 'उपनन्द', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_32', name: 'चित्रबाण', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_33', name: 'चित्रवर्मा', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_34', name: 'सुवर्मा', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_35', name: 'दुर्विरोचन', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_36', name: 'अयोबाहु', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_37', name: 'महाबाहु', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_38', name: 'चित्रांग', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_39', name: 'चित्रकुण्डल', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_40', name: 'भीमवेग', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_41', name: 'भीमबल', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_42', name: 'बलाकि', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_43', name: 'बलवर्धन', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_44', name: 'उग्रायुध', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_45', name: 'सुषेण', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_46', name: 'कुण्डधार', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_47', name: 'महोदर', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_48', name: 'चित्रायुध', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_49', name: 'निषंगी', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_50', name: 'पाशी', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_51', name: 'वृन्दारक', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_52', name: 'दृढवर्मा', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_53', name: 'दृढक्षत्र', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_54', name: 'सोमकीर्ति', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_55', name: 'अनूदर', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_56', name: 'दृढसंध', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_57', name: 'जरासंघ', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_58', name: 'सत्यसंध', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_59', name: 'सदःसुवाक', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_60', name: 'उग्रश्रवा', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_61', name: 'उग्रसेन', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_62', name: 'सेनानी', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_63', name: 'दुष्पराजय', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_64', name: 'अपराजित', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_65', name: 'कुण्डशायी', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_66', name: 'विशालाक्ष', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_67', name: 'दुराधर', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_68', name: 'दृढहस्त', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_69', name: 'सुहस्त', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_70', name: 'वातवेग', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_71', name: 'सुवर्चस', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_72', name: 'आदित्यकेतु', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_73', name: 'बह्वाशी', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_74', name: 'नागदत्त', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_75', name: 'उग्रशायी', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_76', name: 'कवची', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_77', name: 'क्रथन', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_78', name: 'कुण्डी', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_79', name: 'भीमविक्रम', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_80', name: 'धनुर्धर', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_81', name: 'वीरबाहु', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_82', name: 'अलोलुप', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_83', name: 'अभय', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_84', name: 'रौद्रकर्मा', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_85', name: 'दृढरथाश्रय', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_86', name: 'अनाधृष्य', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_87', name: 'कुण्डभेदी', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_88', name: 'विरावी', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_89', name: 'प्रमथ', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_90', name: 'प्रमाथी', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_91', name: 'दीर्घरोमा', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_92', name: 'दीर्घबाहु', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_93', name: 'व्यूढोरस्क', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_94', name: 'कनकध्वज', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_95', name: 'कुण्डाशी', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },
    { id: 'kaurava_96', name: 'विरजा', subtitle: 'कौरव', parent: 'dhritarashtra_chandra', mother: 'gandhari_chandra', yug: 'dwapar', clusterName: 'अन्य कौरव (96)' },

    // --- पाण्डु का परिवार (पांडव) ---
    { id: 'madri_chandra', name: 'माद्री', subtitle: 'पाण्डु पत्नी', parent: '', spouseOf: 'pandu_chandra', yug: 'dwapar' },

    // युधिष्ठिर
    { id: 'yudhishthir_chandra', name: 'युधिष्ठिर', subtitle: 'धर्मराज / पांडव', parent: 'pandu_chandra', mother: 'kunti_chandra', yug: 'dwapar' },
    ...
    // भीम
    { id: 'bhim_chandra', name: 'भीम (वृकोदर)', subtitle: 'पवन पुत्र / पांडव', parent: 'pandu_chandra', mother: 'kunti_chandra', yug: 'dwapar' },
    ...
    { id: 'sutasoma_chandra', name: 'सुतसोम', subtitle: 'द्रौपदी पुत्र (उपपांडव)', parent: 'bhim_chandra', mother: 'draupadi_chandra', yug: 'dwapar', clusterName: 'उपपांडव' },
    ...
    // अर्जुन
    { id: 'arjun_chandra', name: 'अर्जुन (पार्थ)', subtitle: 'इंद्र पुत्र / पांडव', parent: 'pandu_chandra', mother: 'kunti_chandra', yug: 'dwapar' },
    { id: 'ulupi_chandra', name: 'उलूपी', subtitle: 'नाग कन्या / अर्जुन पत्नी', parent: 'kauravya_naga', spouseOf: 'arjun_chandra', yug: 'dwapar' },
    { id: 'chitrangada_wife_chandra', name: 'चित्रांगदा', subtitle: 'मणिपुर पुत्री / अर्जुन पत्नी', parent: 'chitravahana', spouseOf: 'arjun_chandra', yug: 'dwapar' },
    { id: 'shrutakarma_chandra', name: 'श्रुतकर्मा', subtitle: 'द्रौपदी पुत्र (उपपांडव)', parent: 'arjun_chandra', mother: 'draupadi_chandra', yug: 'dwapar', clusterName: 'उपपांडव' },
    ...
    // नकुल
    { id: 'nakul_chandra', name: 'नकुल', subtitle: 'अश्विनी कुमार पुत्र', parent: 'pandu_chandra', mother: 'madri_chandra', yug: 'dwapar' },
    ...
    { id: 'shatanika_upa_chandra', name: 'शतानीक', subtitle: 'द्रौपदी पुत्र (उपपांडव)', parent: 'nakul_chandra', mother: 'draupadi_chandra', yug: 'dwapar', clusterName: 'उपपांडव' },
    { id: 'niramitra_chandra', name: 'निरमित्र', subtitle: 'नकुल पुत्र', parent: 'nakul_chandra', mother: 'karenumati_chandra', yug: 'dwapar' },

    // सहदेव
    { id: 'sahadev_chandra', name: 'सहदेव', subtitle: 'अश्विनी कुमार पुत्र', parent: 'pandu_chandra', mother: 'madri_chandra', yug: 'dwapar' },
    ...
    { id: 'shrutasena_upa_chandra', name: 'श्रुतसेन', subtitle: 'द्रौपदी पुत्र (उपपांडव)', parent: 'sahadev_chandra', mother: 'draupadi_chandra', yug: 'dwapar', clusterName: 'उपपांडव' },
