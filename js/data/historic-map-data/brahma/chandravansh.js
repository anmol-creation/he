export const chandravanshData = [
    ...
    { id: 'sabhanara_anu', name: 'सभानर', subtitle: 'अनु पुत्र', parent: 'anu_yayati_chandra', yug: 'treta', clusterName: 'अनु वंश' },
    { id: 'kalanara_anu', name: 'कालानर', subtitle: 'सभानर पुत्र', parent: 'sabhanara_anu', yug: 'treta', clusterName: 'अनु वंश' },
    { id: 'srinjaya_anu', name: 'सृंजय', subtitle: 'कालानर पुत्र', parent: 'kalanara_anu', yug: 'treta', clusterName: 'अनु वंश' },
    { id: 'puranjaya_anu', name: 'पुरंजय', subtitle: 'सृंजय पुत्र', parent: 'srinjaya_anu', yug: 'treta', clusterName: 'अनु वंश' },
    { id: 'janamejaya_anu', name: 'जनमेजय', subtitle: 'पुरंजय पुत्र', parent: 'puranjaya_anu', yug: 'treta', clusterName: 'अनु वंश' },
    { id: 'mahashala_anu', name: 'महाशाल', subtitle: 'जनमेजय पुत्र', parent: 'janamejaya_anu', yug: 'treta', clusterName: 'अनु वंश' },
    { id: 'mahamana_anu', name: 'महामना', subtitle: 'महाशाल पुत्र', parent: 'mahashala_anu', yug: 'treta', clusterName: 'अनु वंश' },
    { id: 'titikshu_anu', name: 'तितिक्षु', subtitle: 'पूर्वी राज्यों के संस्थापक', parent: 'mahamana_anu', yug: 'treta', clusterName: 'अनु वंश', parichay: 'महामना के पुत्र जिन्होंने पूर्वी भारत की ओर जाकर अपना अलग राज्य स्थापित किया।' },
    { id: 'kushadratha_anu', name: 'कुशधृत', subtitle: 'तितिक्षु पुत्र', parent: 'titikshu_anu', yug: 'treta', clusterName: 'अनु वंश' },
    { id: 'homa_anu', name: 'होम', subtitle: 'कुशधृत पुत्र', parent: 'kushadratha_anu', yug: 'treta', clusterName: 'अनु वंश' },
    { id: 'sutapas_anu', name: 'सुतपस', subtitle: 'होम पुत्र', parent: 'homa_anu', yug: 'treta', clusterName: 'अनु वंश' },
    { id: 'bali_anu', name: 'बलि', subtitle: 'सुतपस पुत्र', parent: 'sutapas_anu', yug: 'dwapar', clusterName: 'अनु वंश', parichay: 'पूर्वी क्षेत्र के महान राजा बलि। इन्होंने ऋषि दीर्घतमस को अपनी पत्नी सुदेष्णा से नियोग द्वारा पुत्र उत्पन्न करने के लिए आमंत्रित किया था।' },
    ...
    { id: 'dirghatamas_rishi_bengal', name: 'ऋषि दीर्घतमस', subtitle: 'नियोग पिता', parent: 'bali_anu', isProminent: true, yug: 'dwapar', clusterName: 'अनु वंश', parichay: 'राजा बलि के आग्रह पर रानी सुदेष्णा से नियोग कर ५ पुत्रों को जन्म दिया।' },
    { id: 'anga_anu', name: 'अंग', subtitle: 'अंग देश के संस्थापक', parent_id_a: 'bali_anu', parent_id_b: 'dirghatamas_rishi_bengal', mother: 'sudeshna_bali_anu', yug: 'dwapar', clusterName: 'अनु वंश' },
    { id: 'vanga_anu', name: 'वंग', subtitle: 'वंग (बंगाल) के संस्थापक', parent_id_a: 'bali_anu', parent_id_b: 'dirghatamas_rishi_bengal', mother: 'sudeshna_bali_anu', yug: 'dwapar', clusterName: 'अनु वंश', parichay: 'इन्हीं के नाम पर वंग राज्य (वर्तमान बंगाल) का नाम पड़ा।' },
    { id: 'kalinga_anu', name: 'कलिंग', subtitle: 'कलिंग देश के संस्थापक', parent_id_a: 'bali_anu', parent_id_b: 'dirghatamas_rishi_bengal', mother: 'sudeshna_bali_anu', yug: 'dwapar', clusterName: 'अनु वंश' },
    { id: 'pundra_anu', name: 'पुंड्र', subtitle: 'पुंड्र (North Bengal) के संस्थापक', parent_id_a: 'bali_anu', parent_id_b: 'dirghatamas_rishi_bengal', mother: 'sudeshna_bali_anu', yug: 'dwapar', clusterName: 'अनु वंश' },
    { id: 'suhma_anu', name: 'सुह्म', subtitle: 'सुह्म देश के संस्थापक', parent_id_a: 'bali_anu', parent_id_b: 'dirghatamas_rishi_bengal', mother: 'sudeshna_bali_anu', yug: 'dwapar', clusterName: 'अनु वंश' },

    // वंग (बंगाल) की आगे की वंशावली
    { id: 'samudrasena_vanga', name: 'समुद्रसेन', subtitle: 'वंग के राजा (महाभारत काल)', parent: 'vanga_anu', yug: 'dwapar', clusterName: 'अनु वंश', parichay: 'वंग देश के प्रतापी राजा जिन्हें महाभारत काल में भीम ने अपनी दिग्विजय यात्रा के दौरान पराजित किया था।' },
    { id: 'chandrasena_vanga', name: 'चंद्रसेन', subtitle: 'वंग के राजा (महाभारत काल)', parent: 'samudrasena_vanga', yug: 'dwapar', clusterName: 'अनु वंश', parichay: 'समुद्रसेन के पुत्र या उत्तराधिकारी, जिन्हें भीम ने हराया था।' },
    ...
    { id: 'sinhabahu_vanga', name: 'सिंहबाहु', subtitle: 'सिंहपुर के संस्थापक', parent: 'suppadevi_vanga', yug: 'kali', clusterName: 'अनु वंश', source_texts: ['महावंश'], parichay: 'सुप्पदेवी और एक सिंह का पुत्र। इसने कलिंग/राढ़ क्षेत्र में सिंहपुर नामक राज्य की स्थापना की।' },
    { id: 'vijaya_srilanka', name: 'राजकुमार विजय', subtitle: 'श्रीलंका के प्रथम राजा', parent: 'sinhabahu_vanga', yug: 'kali', tags: ['श्रीलंका', 'सिंहली वंश'], source_texts: ['महावंश'], parichay: 'राजा सिंहबाहु का पुत्र। इसे इसके दुष्कर्मों के कारण वंग से निर्वासित कर दिया गया था। यह अपने 700 साथियों के साथ लंका (Tambapanni) पहुँचा और श्रीलंका के पहले सिंहली वंश की स्थापना की।' },

    // पुंड्र की वंशावली
    { id: 'paundraka_vasudeva', name: 'पौंड्रक वासुदेव', subtitle: 'पुंड्र का राजा', parent: 'pundra_anu', yug: 'dwapar', clusterName: 'अनु वंश', tags: ['पुंड्र', 'नकली वासुदेव'], parichay: 'पुंड्र और किरात देश का राजा। यह स्वयं को असली कृष्ण (वासुदेव) मानता था और उन्हीं की तरह सुदर्शन और शंख धारण करता था। यह जरासंध का मित्र था। अंततः भगवान कृष्ण ने इसका वध किया।' },
