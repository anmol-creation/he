export const brahmaBaseData = [
    ...
    { id: 'akuti', name: 'आकूति', subtitle: 'मनु पुत्री', color: '#ff99cc', parent: 'svayambhuva_manu', mother: 'shatarupa', yug: 'satya' },
    { id: 'ruci_prajapati', name: 'रुचि', subtitle: 'प्रजापति', color: '#FFD700', parent: 'brahma', spouseOf: 'akuti', yug: 'satya' },
    { id: 'yajna_avatar', name: 'यज्ञ', subtitle: 'विष्णु अवतार', color: '#FFD700', parent: 'ruci_prajapati', mother: 'akuti', yug: 'satya' },
    { id: 'dakshina', name: 'दक्षिणा', subtitle: 'यज्ञ की पत्नी', color: '#ff99cc', parent: 'ruci_prajapati', mother: 'akuti', spouseOf: 'yajna_avatar', yug: 'satya' },

    { id: 'devahuti', name: 'देवहूति', subtitle: 'मनु पुत्री', color: '#ff99cc', parent: 'svayambhuva_manu', mother: 'shatarupa', yug: 'satya' },
    { id: 'kardama_prajapati', name: 'कर्दम (प्रजापति)', subtitle: 'ब्रह्मा की छाया से', color: '#FFD700', parent: 'brahma', spouseOf: 'devahuti', yug: 'satya' },
    { id: 'kapila_avatar', name: 'कपिल मुनि', subtitle: 'विष्णु अवतार', color: '#FFD700', parent: 'kardama_prajapati', mother: 'devahuti', yug: 'satya', parichay: 'सांख्य दर्शन के प्रणेता महान मुनि और विष्णु के अवतार।' },
    { id: 'kala', name: 'कला', subtitle: 'कर्दम पुत्री', color: '#ff99cc', parent: 'kardama_prajapati', mother: 'devahuti', spouseOf: 'marichi', yug: 'satya' },
    { id: 'anusuya', name: 'अनुसूया', subtitle: 'कर्दम पुत्री / अत्रि पत्नी', color: '#ff99cc', parent: 'kardama_prajapati', mother: 'devahuti', spouseOf: 'atri', yug: 'satya', parichay: 'सती अनुसूया, जिन्होंने त्रिदेवों को बालक बना दिया था।' },
    { id: 'shanti', name: 'शांति', subtitle: 'कर्दम पुत्री / अथर्वा पत्नी', color: '#ff99cc', parent: 'kardama_prajapati', mother: 'devahuti', yug: 'satya' },

    { id: 'prasuti', name: 'प्रसूति', subtitle: 'मनु पुत्री', color: '#ff99cc', parent: 'svayambhuva_manu', mother: 'shatarupa', spouseOf: 'daksha', yug: 'satya' },

    { id: 'uttanapada', name: 'उत्तानपाद', subtitle: 'मनु के पुत्र', color: '#FF9900', parent: 'svayambhuva_manu', mother: 'shatarupa', yug: 'satya' },
    { id: 'suniti', name: 'सुनीति', subtitle: 'उत्तानपाद पत्नी', color: '#ff99cc', parent: '', spouseOf: 'uttanapada', yug: 'satya' },
    { id: 'suruchi', name: 'सुरुचि', subtitle: 'उत्तानपाद पत्नी', color: '#ff99cc', parent: '', spouseOf: 'uttanapada', yug: 'satya' },
    { id: 'uttama', name: 'उत्तम', subtitle: 'उत्तानपाद पुत्र', color: '#FF9900', parent: 'uttanapada', mother: 'suruchi', yug: 'satya' },
    { id: 'dhruva', name: 'ध्रुव', subtitle: 'परम भक्त / ध्रुव तारा', color: '#FF9900', parent: 'uttanapada', mother: 'suniti', yug: 'satya' },
    { id: 'shlishti', name: 'श्लिष्टि', subtitle: 'ध्रुव पुत्र', color: '#FF9900', parent: 'dhruva', yug: 'satya' },
    { id: 'ripu', name: 'रिपु', subtitle: 'श्लिष्टि पुत्र', color: '#FF9900', parent: 'shlishti', yug: 'satya' },
    { id: 'chakshusha_manu', name: 'चाक्षुष मनु', subtitle: 'रिपु पुत्र', color: '#FF9900', parent: 'ripu', yug: 'satya', parichay: 'छठे मन्वंतर के अधिपति चाक्षुष मनु।' },
    { id: 'uru', name: 'उरु', subtitle: 'मनु पुत्र', color: '#FF9900', parent: 'chakshusha_manu', yug: 'satya' },
    { id: 'anga_king', name: 'अंग (वेन के पिता)', subtitle: 'उरु पुत्र', color: '#FF9900', parent: 'uru', yug: 'satya' },
    { id: 'vena', name: 'वेन', subtitle: 'अधर्मी राजा', color: '#FF9900', parent: 'anga_king', yug: 'satya' },
    { id: 'prithu', name: 'पृथु', subtitle: 'जिनके नाम पर पृथ्वी', color: '#FF9900', parent: 'vena', yug: 'satya' },
    { id: 'vijitashva', name: 'विजिताश्व', subtitle: 'पृथु पुत्र', color: '#FF9900', parent: 'prithu', yug: 'satya' },
    { id: 'haryashva', name: 'हर्यश्व', subtitle: 'विजिताश्व पुत्र', color: '#FF9900', parent: 'vijitashva', yug: 'satya' },
    { id: 'prachinabarhi', name: 'प्राचीनबर्हि', subtitle: 'हर्यश्व पुत्र', color: '#FF9900', parent: 'haryashva', yug: 'satya' },
    { id: 'pracetas', name: 'प्रचेतागण (10)', subtitle: 'प्राचीनबर्हि पुत्र', color: '#FF9900', parent: 'prachinabarhi', yug: 'satya', parichay: 'प्राचीनबर्हि के 10 पुत्र जिन्होंने 10,000 वर्ष समुद्र में तपस्या की।' },

    { id: 'priyavrata', name: 'प्रियव्रत', subtitle: 'मनु के पुत्र', color: '#FF9900', parent: 'svayambhuva_manu', mother: 'shatarupa', yug: 'satya' },
    { id: 'agnidhra', name: 'आग्नीध्र', subtitle: 'प्रियव्रत पुत्र', color: '#FF9900', parent: 'priyavrata', yug: 'satya', parichay: 'जम्बूद्वीप (एशिया) के प्रथम शासक।' },
    { id: 'nabhi', name: 'नाभि', subtitle: 'आग्नीध्र पुत्र', color: '#FF9900', parent: 'agnidhra', yug: 'satya' },
    { id: 'merudevi', name: 'मेरुदेवी', subtitle: 'नाभि पत्नी', color: '#ff99cc', parent: '', spouseOf: 'nabhi', yug: 'satya' },
    { id: 'rishabhdev', name: 'ऋषभदेव', subtitle: 'तीर्थंकर / विष्णु अवतार', color: '#FFD700', parent: 'nabhi', mother: 'merudevi', yug: 'satya', parichay: 'भगवान विष्णु के अंशावतार और जैन धर्म के प्रथम तीर्थंकर (आदिनाथ)।' },
    { id: 'jayanti_rishabha', name: 'जयन्ती', subtitle: 'इंद्र पुत्री / ऋषभ पत्नी', color: '#ff99cc', parent: '', spouseOf: 'rishabhdev', yug: 'satya' },
    { id: 'bharata_jada', name: 'भरत (जड़ भरत)', subtitle: 'चक्रवर्ती सम्राट', color: '#FF9900', parent: 'rishabhdev', mother: 'jayanti_rishabha', yug: 'satya', parichay: 'महान चक्रवर्ती सम्राट, जिनके नाम पर हमारे देश का नाम भारतवर्ष पड़ा।' },

    // Deeper Lineage of Bharata
    { id: 'sumati_bharata', name: 'सुमति', subtitle: 'भरत पुत्र', color: '#FF9900', parent: 'bharata_jada', yug: 'satya' },
    { id: 'devatajit', name: 'देवतजित', subtitle: 'सुमति पुत्र', color: '#FF9900', parent: 'sumati_bharata', yug: 'satya' },
    { id: 'devadyumna', name: 'देवद्युम्न', subtitle: 'देवतजित पुत्र', color: '#FF9900', parent: 'devatajit', yug: 'satya' },
    { id: 'parameshthi', name: 'परमेष्ठी', subtitle: 'देवद्युम्न पुत्र', color: '#FF9900', parent: 'devadyumna', yug: 'satya' },
    { id: 'pratiha', name: 'प्रतीह', subtitle: 'परमेष्ठी पुत्र', color: '#FF9900', parent: 'parameshthi', yug: 'satya' },
    { id: 'pratihartri', name: 'प्रतिहर्त्री', subtitle: 'प्रतीह पुत्र', color: '#FF9900', parent: 'pratiha', yug: 'satya' },
    { id: 'bhumana', name: 'भूमन', subtitle: 'प्रतिहर्त्री पुत्र', color: '#FF9900', parent: 'pratihartri', yug: 'satya' },
    { id: 'udgitha', name: 'उद्गीथ', subtitle: 'भूमन पुत्र', color: '#FF9900', parent: 'bhumana', yug: 'satya' },
    { id: 'prastota', name: 'प्रस्तोता', subtitle: 'उद्गीथ पुत्र', color: '#FF9900', parent: 'udgitha', yug: 'satya' },
    { id: 'vibhu', name: 'विभु', subtitle: 'प्रस्तोता पुत्र', color: '#FF9900', parent: 'prastota', yug: 'satya' },
    { id: 'prithushena', name: 'पृथुषेण', subtitle: 'विभु पुत्र', color: '#FF9900', parent: 'vibhu', yug: 'satya' },
    { id: 'nakta', name: 'नक्त', subtitle: 'पृथुषेण पुत्र', color: '#FF9900', parent: 'prithushena', yug: 'satya' },
    { id: 'gaya', name: 'गया (राजर्षि)', subtitle: 'नक्त पुत्र', color: '#FF9900', parent: 'nakta', yug: 'satya', parichay: 'विष्णु के अंशावतार और एक अत्यंत महान और न्यायप्रिय राजर्षि। विष्णु पुराण और भागवत के अनुसार ये बहुत बड़े सिद्ध राजा थे।' },
