export const brahmaBaseData = [
    ...
    { id: 'sanak', name: 'सनक', subtitle: 'सनत कुमार', parent: 'brahma', yug: 'satya', timeScale: 'kalpa' },
    { id: 'sanandan', name: 'सनन्दन', subtitle: 'सनत कुमार', parent: 'brahma', yug: 'satya', timeScale: 'kalpa' },
    { id: 'sanatan', name: 'सनातन', subtitle: 'सनत कुमार', parent: 'brahma', yug: 'satya', timeScale: 'kalpa' },
    { id: 'sanatkumar', name: 'सनत्कुमार', subtitle: 'सनत कुमार', parent: 'brahma', yug: 'satya', timeScale: 'kalpa' },
    { id: 'narada', name: 'नारद', subtitle: 'मानस पुत्र / देवर्षि', parent: 'brahma', yug: 'satya' , parichay: 'देवर्षि नारद, ब्रह्मा के मानस पुत्र।', events: ['वाल्मीकि को राम कथा संक्षेप में सुनाई (बालकाण्ड, सर्ग 1)'], timeScale: 'kalpa' },
    ...
    { id: 'svayambhuva_manu', name: 'स्वायंभुव मनु', subtitle: 'प्रथम पुरुष', parent: 'brahma', yug: 'satya', manvantara: 1 },
    ...
    { id: 'karna', name: 'कर्ण (राधेय)', subtitle: 'अंगराज', parent: 'surya', mother: 'kunti_surya_proxy', yug: 'dwapar', parichay: 'सूर्य और कुंती के पुत्र, जिन्हें अधिरथ और राधा ने पाला। दुर्योधन ने इन्हें अंग देश का राजा बनाया।' },
    { id: 'vrushali_wife', name: 'वृषाली', subtitle: 'कर्ण की पत्नी', parent: '', spouseOf: 'karna', yug: 'dwapar', clusterName: 'कर्ण की पत्नियाँ' },
    { id: 'supriya_wife', name: 'सुप्रिया', subtitle: 'कर्ण की पत्नी', parent: '', spouseOf: 'karna', yug: 'dwapar', clusterName: 'कर्ण की पत्नियाँ' },
    { id: 'vrishasena', name: 'वृषसेन', subtitle: 'कर्ण पुत्र', parent: 'karna', mother: 'vrushali_wife', yug: 'dwapar' },
    { id: 'vrishaketu', name: 'वृषकेतु', subtitle: 'कर्ण पुत्र', parent: 'karna', mother: 'supriya_wife', yug: 'dwapar', parichay: 'कुरुक्षेत्र युद्ध में जीवित बचे कर्ण के एकमात्र पुत्र।' },
    { id: 'chitrasena_karna', name: 'चित्रसेन', subtitle: 'कर्ण पुत्र', parent: 'karna', yug: 'dwapar' },
    { id: 'satyasena_karna', name: 'सत्यसेन', subtitle: 'कर्ण पुत्र', parent: 'karna', yug: 'dwapar' },
    { id: 'sushena_karna', name: 'सुषेण', subtitle: 'कर्ण पुत्र', parent: 'karna', yug: 'dwapar' },
    { id: 'shatrunjaya_karna', name: 'शत्रुंजय', subtitle: 'कर्ण पुत्र', parent: 'karna', yug: 'dwapar' },
    { id: 'dvipata_karna', name: 'द्विपात', subtitle: 'कर्ण पुत्र', parent: 'karna', yug: 'dwapar' },
    { id: 'prasena_karna', name: 'प्रसेन', subtitle: 'कर्ण पुत्र', parent: 'karna', yug: 'dwapar' },
    { id: 'banasena_karna', name: 'बाणसेन', subtitle: 'कर्ण पुत्र', parent: 'karna', yug: 'dwapar' },
