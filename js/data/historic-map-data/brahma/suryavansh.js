...
{ id: 'vikukshi', name: 'विकुक्षि', subtitle: 'शशाद', parent: 'suryavansh_proxy', yug: 'satya', kali_year: -2160000, parichay: 'इक्ष्वाकु के सौ पुत्रों में ज्येष्ठ। इन्होंने सूर्यवंश को आगे बढ़ाया।' },
    ...
    { id: 'avubai_vithoji', name: 'आऊबाई', gender: 'female', subtitle: 'विठोजी की पत्नी', parent: '', spouseOf: 'vithoji_bhonsle', yug: 'kali', kali_year: 4658, parichay: 'जन्म: 1556 ई. (अनुमानित)।', clusterName: 'मराठा (भोंसले) वंश' },

    // Family of Vithoji Bhosale (8 Sons)
    { id: 'kheloji_bhonsle', name: 'खेलोजी भोंसले', gender: 'male', subtitle: 'विठोजी के पुत्र', parent: 'vithoji_bhonsle', mother: 'avubai_vithoji', yug: 'kali', kali_year: 4676, parichay: 'जन्म: 1574 ई. (अनुमानित)। विठोजी के ज्येष्ठ पुत्र।', clusterName: 'मराठा (भोंसले) वंश' },
    { id: 'parsoji_bhonsle', name: 'परसोजी भोंसले', gender: 'male', subtitle: 'विठोजी के पुत्र', parent: 'vithoji_bhonsle', mother: 'avubai_vithoji', yug: 'kali', kali_year: 4678, parichay: 'जन्म: 1576 ई. (अनुमानित)। विठोजी के पुत्र।', clusterName: 'मराठा (भोंसले) वंश' },
    { id: 'maloji_ii_bhonsle', name: 'मालोजी द्वितीय', gender: 'male', subtitle: 'विठोजी के पुत्र', parent: 'vithoji_bhonsle', mother: 'avubai_vithoji', yug: 'kali', kali_year: 4680, parichay: 'जन्म: 1578 ई. (अनुमानित)। विठोजी के पुत्र।', clusterName: 'मराठा (भोंसले) वंश' },
    { id: 'mambaji_bhonsle', name: 'मंबाजी भोंसले', gender: 'male', subtitle: 'विठोजी के पुत्र', parent: 'vithoji_bhonsle', mother: 'avubai_vithoji', yug: 'kali', kali_year: 4682, parichay: 'जन्म: 1580 ई. (अनुमानित)। विठोजी के पुत्र।', clusterName: 'मराठा (भोंसले) वंश' },
    { id: 'sambhaji_vithoji_bhonsle', name: 'सम्भाजी भोंसले (विठोजी पुत्र)', gender: 'male', subtitle: 'विठोजी के पुत्र', parent: 'vithoji_bhonsle', mother: 'avubai_vithoji', yug: 'kali', kali_year: 4684, parichay: 'जन्म: 1582 ई. (अनुमानित) | लखूजी जाधव के साथ हुए एक संघर्ष में इनकी मृत्यु हो गई थी।', clusterName: 'मराठा (भोंसले) वंश' },
    { id: 'nagoji_bhonsle', name: 'नागोजी भोंसले', gender: 'male', subtitle: 'विठोजी के पुत्र', parent: 'vithoji_bhonsle', mother: 'avubai_vithoji', yug: 'kali', kali_year: 4686, parichay: 'जन्म: 1584 ई. (अनुमानित)। विठोजी के पुत्र।', clusterName: 'मराठा (भोंसले) वंश' },
    { id: 'trimbakji_vithoji_bhonsle', name: 'त्र्यंबकजी भोंसले', gender: 'male', subtitle: 'विठोजी के पुत्र', parent: 'vithoji_bhonsle', mother: 'avubai_vithoji', yug: 'kali', kali_year: 4688, parichay: 'जन्म: 1586 ई. (अनुमानित)। विठोजी के पुत्र।', clusterName: 'मराठा (भोंसले) वंश' },
    { id: 'kavkaji_bhonsle', name: 'कावकाजी (काकाजी) भोंसले', gender: 'male', subtitle: 'विठोजी के पुत्र', parent: 'vithoji_bhonsle', mother: 'avubai_vithoji', yug: 'kali', kali_year: 4690, parichay: 'जन्म: 1588 ई. (अनुमानित)। विठोजी के पुत्र।', clusterName: 'मराठा (भोंसले) वंश' },
    ...
    { id: 'sharifji_bhonsle', name: 'शरीफजी भोंसले', gender: 'male', subtitle: 'मालोजी के पुत्र', parent: 'maloji_bhonsle', yug: 'kali', kali_year: 4698, parichay: 'जन्म: 1596 ई. (अनुमानित) | मृत्यु: 1624 ई.। शाहजी के छोटे भाई। भातवड़ी के युद्ध (1624 ई.) में वीरगति प्राप्त की।', clusterName: 'मराठा (भोंसले) वंश' },
    { id: 'durgabai_sharifji', name: 'दुर्गाबाई', gender: 'female', subtitle: 'शरीफजी की पत्नी', parent: '', spouseOf: 'sharifji_bhonsle', yug: 'kali', kali_year: 4700, parichay: 'जन्म: 1598 ई. (अनुमानित)। जुन्नर के विश्वासराव की पुत्री।', clusterName: 'मराठा (भोंसले) वंश' },
    { id: 'trimbakji_sharifji_bhonsle', name: 'त्र्यंबकजी (खानोट शाखा)', gender: 'male', subtitle: 'शरीफजी के पुत्र', parent: 'sharifji_bhonsle', mother: 'durgabai_sharifji', yug: 'kali', kali_year: 4716, parichay: 'जन्म: 1614 ई. (अनुमानित)। शरीफजी के वीरगति प्राप्त होने के बाद इन्होने खानोट (Khanot) शाखा को आगे बढ़ाया।', clusterName: 'मराठा (भोंसले) वंश' },
