export const suryavanshData = [
    ...
    { id: 'mohandas', name: 'मोहनदास', subtitle: 'शीघ्र पुत्र', parent: 'shighra', yug: 'dwapar', parichay: 'भगवान विष्णु (रंगनाथ) के परम भक्त थे। इन्होंने कावेरी नदी के तट पर अनेक मंदिर बनवाए।' },
    { id: 'neminath_suryavansh', name: 'नेमिनाथ', subtitle: 'मोहनदास पुत्र', parent: 'mohandas', yug: 'dwapar', parichay: 'इन्होंने नेपाल में अपना राज्य स्थापित किया था।' },
    { id: 'vrand', name: 'व्रंद', subtitle: 'नेमिनाथ पुत्र', parent: 'neminath_suryavansh', yug: 'dwapar' },
    { id: 'raja_vallabh', name: 'महाराजा वल्लभ देव', subtitle: 'प्रतापनगर के राजा', parent: 'vrand', yug: 'dwapar', parichay: 'ये कुश की पीढ़ी में प्रतापनगर के सूर्यवंशी राजा थे। महाभारत युद्ध में पांडवों की ओर से लड़ते हुए भीष्म पितामह के हाथों वीरगति को प्राप्त हुए।' },
    { id: 'bhagwati_devi', name: 'भगवती देवी', subtitle: 'वल्लभ देव की पत्नी', parent: '', spouseOf: 'raja_vallabh', yug: 'dwapar' },
    { id: 'maharaja_agrasen', name: 'महाराजा अग्रसेन', subtitle: 'अग्रवाल वंश संस्थापक', parent: 'raja_vallabh', mother: 'bhagwati_devi', yug: 'dwapar', parichay: 'इन्होंने अग्रोहा नगर की स्थापना की और 18 गोत्रों की शुरुआत की, जिससे अग्रवाल समाज का निर्माण हुआ। 15 वर्ष की आयु में इन्होने महाभारत युद्ध में पांडवों की ओर से भाग लिया था।', clusterName: 'अग्रवाल वंश' },
    { id: 'shursen', name: 'शूरसेन', subtitle: 'महाराजा वल्लभ देव के पुत्र', parent: 'raja_vallabh', mother: 'bhagwati_devi', yug: 'dwapar', parichay: 'महाराजा अग्रसेन के छोटे भाई।', clusterName: 'अग्रवाल वंश' },

    // Agrasen's Wives and 18 Sons
    { id: 'madhavi_agrasen', name: 'माधवी', subtitle: 'महाराजा अग्रसेन की पत्नी', parent: '', spouseOf: 'maharaja_agrasen', yug: 'dwapar', parichay: 'ये नागराज कुमुद की पुत्री (नागवंशी) थीं।', clusterName: 'अग्रवाल वंश' },
    { id: 'nandini_agrasen', name: 'नंदिनी', subtitle: 'महाराजा अग्रसेन की पत्नी', parent: '', spouseOf: 'maharaja_agrasen', yug: 'dwapar', clusterName: 'अग्रवाल वंश' },
