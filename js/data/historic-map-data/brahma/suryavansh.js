export const suryavanshData = [
    { id: 'vaivasvata_manu', name: 'वैवस्वत मनु', subtitle: 'वर्तमान मनु', parent: 'surya', yug: 'satya', kali_year: -3888000 },
    ...
    { id: 'ikshvaku', name: 'इक्ष्वाकु', subtitle: 'सूर्यवंश के संस्थापक', parent: 'vaivasvata_manu', mother: 'shraddha_manu_wife', yug: 'satya', kali_year: -3888000 },
...
{ id: 'vikukshi', name: 'विकुक्षि', subtitle: 'शशाद', parent: 'suryavansh_proxy', yug: 'satya', kali_year: -2160000, parichay: 'इक्ष्वाकु के सौ पुत्रों में ज्येष्ठ। इन्होंने सूर्यवंश को आगे बढ़ाया।' },
    ...
    { id: 'puranjaya', name: 'पुरंजय', subtitle: 'ककुत्स्थ / इन्द्रवाह', parent: 'vikukshi', yug: 'treta', kali_year: -2139096, parichay: 'इन्होंने देवासुर संग्राम में वृषभ रूपी इन्द्र पर बैठकर युद्ध किया था।' },
    ...
    { id: 'sajjan_singh_bhonsle', name: 'सज्जन सिंह (सुजनसिंह)', gender: 'male', subtitle: 'भोंसले वंश के मूल पुरुष', parent: 'rana_ajay_singh', yug: 'kali', kali_year: 4393, parichay: 'जन्म: 1291 ई. के पूर्व | मृत्यु: ~1350 ई.। मेवाड़ छोड़कर 1333 ई. में दक्षिण (दक्कन) चले गए और बहमनी सुल्तान के यहाँ मीरत की जागीर प्राप्त की। इन्हीं के वंशज आगे चलकर "भोंसले" कहलाए।' },
    ...
    { id: 'dilip_singh_bhonsle', name: 'दिलीप सिंह (बाजीराजा)', gender: 'male', subtitle: 'सज्जन सिंह पुत्र', parent: 'maratha_empire_proxy', yug: 'kali', kali_year: 4432, parichay: 'जन्म: 1330 ई. (अनुमानित) | मीरत के जागीरदार। विजयनगर के विरुद्ध युद्धों में (1353-1365) वीरता दिखाई। मृत्यु: 1365 ई. के पूर्व।', clusterName: 'मराठा (भोंसले) वंश' },
    { id: 'sidhji_bhonsle', name: 'शिधाजी (सिधजी)', gender: 'male', subtitle: 'दिलीप सिंह पुत्र', parent: 'dilip_singh_bhonsle', yug: 'kali', kali_year: 4452, parichay: 'जन्म: 1350 ई. (अनुमानित) | सुल्तान मुजाहिद शाह के अंगरक्षक। 1388 ई. से पूर्व युद्ध में वीरगति।', clusterName: 'मराठा (भोंसले) वंश' },
    { id: 'bhairav_singh_bhosaji', name: 'भैरव सिंह (भोसाजी)', gender: 'male', subtitle: 'भोंसले नाम के प्रवर्तक', parent: 'sidhji_bhonsle', yug: 'kali', kali_year: 4472, parichay: 'जन्म: 1370 ई. (अनुमानित) | मुधोल के जागीरदार (1397 ई.)। इन्हीं के नाम (भोसाजी) या "भोसावट" जागीर के नाम पर इस वंश का नाम "भोंसले" पड़ा। मृत्यु: 1398 ई.।', clusterName: 'मराठा (भोंसले) वंश' },
    { id: 'devaraj_bhonsle', name: 'देवराज भोंसले', gender: 'male', subtitle: 'भैरव सिंह पुत्र', parent: 'bhairav_singh_bhosaji', yug: 'kali', kali_year: 4492, parichay: 'जन्म: 1390 ई. (अनुमानित) | मुधोल के शासक। मृत्यु: 1422 ई.।', clusterName: 'मराठा (भोंसले) वंश' },
    ...
    { id: 'babaji_bhonsle', name: 'बाबाजी भोंसले', gender: 'male', subtitle: 'वेरुल के पाटिल', parent: 'bhonsle_medieval_link', yug: 'kali', kali_year: 4632, parichay: 'जन्म: 1530 ई. (अनुमानित) | मृत्यु: 1597 ई.। पुणे के निकट हिंगनी, बेरडी और देवलगाँव के पाटिल। शुभकृष्ण के पौत्र।', clusterName: 'मराठा (भोंसले) वंश' },
    ...
    { id: 'sharifji_bhonsle', name: 'शरीफजी भोंसले', gender: 'male', subtitle: 'मालोजी के पुत्र', parent: 'maloji_bhonsle', mother: 'umabai_nimbalkar', yug: 'kali', kali_year: 4698, parichay: 'जन्म: 1596 ई. (अनुमानित) | मृत्यु: 1624 ई.। शाहजी के छोटे भाई। भातवड़ी के युद्ध (1624 ई.) में वीरगति प्राप्त की।', clusterName: 'मराठा (भोंसले) वंश' },
    ...
    { id: 'jijabai_jadhav', name: 'राजमाता जीजाबाई', gender: 'female', subtitle: 'शाहजी की प्रथम पत्नी', parent: '', spouseOf: 'shahaji_bhonsle', yug: 'kali', kali_year: 4700, parichay: 'जन्म: 12 जनवरी 1598 (सिंदखेड राजा) | मृत्यु: 17 जून 1674। छत्रपति शिवाजी महाराज की माता और उनकी सबसे बड़ी प्रेरणा।', clusterName: 'शाहजी की पत्नियाँ' },
    { id: 'tukabai_mohite', name: 'तुकाबाई मोहिते', gender: 'female', subtitle: 'शाहजी की द्वितीय पत्नी', parent: '', spouseOf: 'shahaji_bhonsle', yug: 'kali', parichay: 'शाहजी महाराज की दूसरी पत्नी और व्यंकोजी (एकोजी) की माता।', clusterName: 'शाहजी की पत्नियाँ' },
    ...
    // Shahaji's other wives and children
    { id: 'narsabai_bhosale', name: 'नरसाबाई', gender: 'female', subtitle: 'शाहजी की तृतीय पत्नी', parent: '', spouseOf: 'shahaji_bhonsle', yug: 'kali', clusterName: 'शाहजी की पत्नियाँ' },
    { id: 'shahaji_up_patni', name: 'शाहजी की उप-पत्नियाँ', gender: 'female', subtitle: 'अज्ञात (नाटकशाला)', parent: '', spouseOf: 'shahaji_bhonsle', yug: 'kali', isProxy: true, clusterName: 'शाहजी की पत्नियाँ' },

    // Sambhaji's wife (Elder brother of Shivaji)
    { id: 'jayantibai_bhosale', name: 'जयंतीबाई (जीवाबाई)', gender: 'female', subtitle: 'सम्भाजी (शाहजी पुत्र) की पत्नी', parent: '', spouseOf: 'sambhaji_shahaji_bhosale', yug: 'kali', clusterName: 'मराठा (भोंसले) वंश' },

    // Sons of Tukabai (other than Ekoji I)
    { id: 'koyaji_bhonsle', name: 'कोयाजी भोंसले', gender: 'male', subtitle: 'शाहजी व तुकाबाई के पुत्र', parent: 'shahaji_bhonsle', mother: 'tukabai_mohite', yug: 'kali', clusterName: 'मराठा (भोंसले) वंश' },

    // Son of Narsabai
    { id: 'santaji_bhonsle', name: 'संताजी भोंसले', gender: 'male', subtitle: 'शाहजी व नरसाबाई के पुत्र', parent: 'shahaji_bhonsle', mother: 'narsabai_bhosale', yug: 'kali', kali_year: 4737, parichay: 'जन्म: 1635 ई. (अनुमानित) | मृत्यु: अज्ञात। शिवाजी महाराज ने इन्हें वेल्लोर (Vellore) की जागीर सौंपी थी।', clusterName: 'मराठा (भोंसले) वंश' },

    // Illegitimate Sons of Shahaji (from Concubines / Natakshala)
    { id: 'bhivji_bhonsle', name: 'भिवजी भोंसले', gender: 'male', subtitle: 'शाहजी के पुत्र (उपपत्नी से)', parent: 'shahaji_bhonsle', mother: 'shahaji_up_patni', yug: 'kali', clusterName: 'मराठा (भोंसले) वंश' },
    { id: 'pratapji_bhonsle', name: 'प्रतापजी भोंसले', gender: 'male', subtitle: 'शाहजी के पुत्र (उपपत्नी से)', parent: 'shahaji_bhonsle', mother: 'shahaji_up_patni', yug: 'kali', clusterName: 'मराठा (भोंसले) वंश' },
    { id: 'hiroji_farzand', name: 'हिरोजी फर्ज़ंद', gender: 'male', subtitle: 'शाहजी के पुत्र (उपपत्नी से)', parent: 'shahaji_bhonsle', mother: 'shahaji_up_patni', yug: 'kali', parichay: 'शिवाजी महाराज के हमशक्ल और विश्वासपात्र, जिन्होंने आगरा से भागने में शिवाजी की मदद की थी।', clusterName: 'मराठा (भोंसले) वंश' },
    { id: 'raibhanji_bhonsle', name: 'रायभानजी भोंसले', gender: 'male', subtitle: 'शाहजी के पुत्र (उपपत्नी से)', parent: 'shahaji_bhonsle', mother: 'shahaji_up_patni', yug: 'kali', clusterName: 'मराठा (भोंसले) वंश' },

    { id: 'ekoji_i', name: 'व्यंकोजी (एकोजी प्रथम)', gender: 'male', subtitle: 'तंजौर मराठा संस्थापक', parent: 'shahaji_bhonsle', mother: 'tukabai_mohite', yug: 'kali', kali_year: 4734, parichay: 'जन्म: 1632 ई. | मृत्यु: 1684 ई.। तंजौर (Thanjavur) मराठा साम्राज्य के संस्थापक। शिवाजी के सौतेले भाई।', clusterName: 'तंजौर (मराठा) वंश' },
    { id: 'dipabai_tanjore', name: 'दीपाबाई (तंजौर)', gender: 'female', subtitle: 'एकोजी प्रथम की पत्नी', parent: '', spouseOf: 'ekoji_i', yug: 'kali', clusterName: 'तंजौर (मराठा) वंश' },

    { id: 'shahuji_i_tanjore', name: 'शाहूजी प्रथम (तंजौर)', gender: 'male', subtitle: 'तंजौर नरेश', parent: 'ekoji_i', mother: 'dipabai_tanjore', yug: 'kali', kali_year: 4774, parichay: 'जन्म: 1672 ई. | मृत्यु: 1712 ई. (शासनकाल: 1684-1712 ई.)। एकोजी प्रथम के ज्येष्ठ पुत्र। इन्होने साहित्य और कला को संरक्षण दिया।', clusterName: 'तंजौर (मराठा) वंश' },
    { id: 'serfoji_i_tanjore', name: 'सरफोजी प्रथम', gender: 'male', subtitle: 'तंजौर नरेश', parent: 'ekoji_i', mother: 'dipabai_tanjore', yug: 'kali', kali_year: 4777, parichay: 'जन्म: 1675 ई. (अनुमानित) | मृत्यु: 1728 ई. (शासनकाल: 1712-1728 ई.)। शाहूजी प्रथम के छोटे भाई।', clusterName: 'तंजौर (मराठा) वंश' },
    { id: 'tukkoji_tanjore', name: 'तुक्कोजी (तुलजाजी प्रथम)', gender: 'male', subtitle: 'तंजौर नरेश', parent: 'ekoji_i', mother: 'dipabai_tanjore', yug: 'kali', kali_year: 4779, parichay: 'जन्म: 1677 ई. (अनुमानित) | मृत्यु: 1736 ई. (शासनकाल: 1728-1736 ई.)। एकोजी प्रथम के तीसरे पुत्र।', clusterName: 'तंजौर (मराठा) वंश' },
    { id: 'annapurna_tanjore', name: 'अन्नपूर्णा', gender: 'female', subtitle: 'तुक्कोजी की उपपत्नी', parent: '', spouseOf: 'tukkoji_tanjore', yug: 'kali', clusterName: 'तंजौर (मराठा) वंश' },

    { id: 'pratap_singh_tanjore', name: 'प्रताप सिंह (तंजौर)', gender: 'male', subtitle: 'तंजौर नरेश', parent: 'tukkoji_tanjore', mother: 'annapurna_tanjore', yug: 'kali', kali_year: 4812, parichay: 'जन्म: 1710 ई. (अनुमानित) | मृत्यु: 16 दिसंबर 1763 ई. (शासनकाल: 1739-1763 ई.)।', clusterName: 'तंजौर (मराठा) वंश' },
    { id: 'thuljaji_tanjore', name: 'तुलजाजी (द्वितीय)', gender: 'male', subtitle: 'तंजौर नरेश', parent: 'pratap_singh_tanjore', yug: 'kali', kali_year: 4840, parichay: 'जन्म: 1738 ई. | मृत्यु: 1787 ई. (शासनकाल: 1763-1787 ई.)। विद्या और कला के महान संरक्षक।', clusterName: 'तंजौर (मराठा) वंश' },
    { id: 'amar_singh_tanjore', name: 'अमर सिंह (तंजौर)', gender: 'male', subtitle: 'तंजौर नरेश (प्रतिशासक)', parent: 'pratap_singh_tanjore', yug: 'kali', kali_year: 4842, parichay: 'जन्म: 1740 ई. (अनुमानित) | मृत्यु: 1802 ई. (शासनकाल: 1787-1798 ई.)। तुलजाजी के सौतेले भाई।', clusterName: 'तंजौर (मराठा) वंश' },

    { id: 'serfoji_ii_tanjore', name: 'सरफोजी द्वितीय', gender: 'male', subtitle: 'महान कला संरक्षक', parent: 'thuljaji_tanjore', yug: 'kali', kali_year: 4879, isProminent: true, parichay: 'जन्म: 24 सितंबर 1777 (दत्तक पुत्र) | मृत्यु: 7 मार्च 1832। सरस्वती महल लाइब्रेरी के विस्तारक, बहुभाषी और महान विद्वान।', clusterName: 'तंजौर (मराठा) वंश' },
    { id: 'avubai_tanjore', name: 'अवूबाई', gender: 'female', subtitle: 'सरफोजी द्वितीय की पत्नी', parent: '', spouseOf: 'serfoji_ii_tanjore', yug: 'kali', clusterName: 'तंजौर (मराठा) वंश' },
    { id: 'shivaji_tanjore', name: 'शिवाजी (तंजौर)', gender: 'male', subtitle: 'अंतिम तंजौर नरेश', parent: 'serfoji_ii_tanjore', mother: 'avubai_tanjore', yug: 'kali', kali_year: 4902, parichay: 'जन्म: 1800 ई. (अनुमानित) | मृत्यु: 29 अक्टूबर 1855 ई. (शासनकाल: 1832-1855 ई.)। इनकी मृत्यु के बाद अंग्रेजों ने राज्य हड़प लिया।', clusterName: 'तंजौर (मराठा) वंश' },
    { id: 'kamakshi_bai_saheb', name: 'कामाक्षी बाई साहेब', gender: 'female', subtitle: 'शिवाजी की पत्नी', parent: '', spouseOf: 'shivaji_tanjore', yug: 'kali', clusterName: 'तंजौर (मराठा) वंश' },
    { id: 'vijaya_mohana_muktamba', name: 'विजया मोहना मुक्ताम्बा', gender: 'female', subtitle: 'शिवाजी की पुत्री', parent: 'shivaji_tanjore', yug: 'kali', clusterName: 'तंजौर (मराठा) वंश' },
    ...
    { id: 'saibai_nimbalkar', name: 'सईबाई निंबालकर', gender: 'female', subtitle: 'शिवाजी की प्रथम पत्नी', parent: '', spouseOf: 'chhatrapati_shivaji_maharaj', yug: 'kali', kali_year: 4735, parichay: 'जन्म: 1633 ई. | मृत्यु: 1659 ई.। सम्भाजी महाराज की माता और शिवाजी महाराज की सबसे प्रिय रानी।', clusterName: 'शिवाजी की पत्नियाँ' },
    { id: 'soyarabai_mohite', name: 'सोयराबाई मोहिते', gender: 'female', subtitle: 'शिवाजी की पत्नी', parent: '', spouseOf: 'chhatrapati_shivaji_maharaj', yug: 'kali', parichay: 'छत्रपति राजाराम की माता।', clusterName: 'शिवाजी की पत्नियाँ' },
    { id: 'putalabai_palkar', name: 'पुतळाबाई पालकर', gender: 'female', subtitle: 'शिवाजी की पत्नी', parent: '', spouseOf: 'chhatrapati_shivaji_maharaj', yug: 'kali', parichay: 'शिवाजी महाराज के निधन के बाद सती हो गईं थीं।', clusterName: 'शिवाजी की पत्नियाँ' },
    { id: 'sakvarbai_gaikwad', name: 'सकवरबाई गायकवाड़', gender: 'female', subtitle: 'शिवाजी की पत्नी', parent: '', spouseOf: 'chhatrapati_shivaji_maharaj', yug: 'kali', parichay: 'कमलाबाई की माता।', clusterName: 'शिवाजी की पत्नियाँ' },
    { id: 'kashibai_jadhav', name: 'काशीबाई जाधव', gender: 'female', subtitle: 'शिवाजी की पत्नी', parent: '', spouseOf: 'chhatrapati_shivaji_maharaj', yug: 'kali', clusterName: 'शिवाजी की पत्नियाँ' },
    { id: 'sagunabai_shirke', name: 'सगुणाबाई शिर्के', gender: 'female', subtitle: 'शिवाजी की पत्नी', parent: '', spouseOf: 'chhatrapati_shivaji_maharaj', yug: 'kali', parichay: 'राजकुंवरबाई की माता।', clusterName: 'शिवाजी की पत्नियाँ' },
    { id: 'gunvantabai_ingle', name: 'गुणवंताबाई इंगले', gender: 'female', subtitle: 'शिवाजी की पत्नी', parent: '', spouseOf: 'chhatrapati_shivaji_maharaj', yug: 'kali', clusterName: 'शिवाजी की पत्नियाँ' },
    { id: 'lakshmibai_vichare', name: 'लक्ष्मीबाई विचारे', gender: 'female', subtitle: 'शिवाजी की पत्नी', parent: '', spouseOf: 'chhatrapati_shivaji_maharaj', yug: 'kali', clusterName: 'शिवाजी की पत्नियाँ' },
    ...
    { id: 'atithi', name: 'अतिथि', subtitle: 'कुश पुत्र', parent: 'kush', mother: 'kumudvati', yug: 'dwapar', kali_year: -864000 },
