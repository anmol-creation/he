...
{ id: 'vikukshi', name: 'विकुक्षि', subtitle: 'शशाद', parent: 'suryavansh_proxy', yug: 'satya', kali_year: -2160000, parichay: 'इक्ष्वाकु के सौ पुत्रों में ज्येष्ठ। इन्होंने सूर्यवंश को आगे बढ़ाया।' },
    ...
    { id: 'shahuji_i_tanjore', name: 'शाहूजी प्रथम (तंजौर)', gender: 'male', subtitle: 'तंजौर नरेश', parent: 'ekoji_i', mother: 'dipabai_tanjore', yug: 'kali', kali_year: 4774, parichay: 'शासनकाल: 1684-1712 ई.। एकोजी प्रथम के ज्येष्ठ पुत्र। इन्होने साहित्य और कला को संरक्षण दिया।', clusterName: 'तंजौर (मराठा) वंश' },
    { id: 'serfoji_i_tanjore', name: 'सरफोजी प्रथम', gender: 'male', subtitle: 'तंजौर नरेश', parent: 'ekoji_i', mother: 'dipabai_tanjore', yug: 'kali', kali_year: 4814, parichay: 'शासनकाल: 1712-1728 ई.। शाहूजी प्रथम के छोटे भाई।', clusterName: 'तंजौर (मराठा) वंश' },
    { id: 'tukkoji_tanjore', name: 'तुक्कोजी (तुलजाजी प्रथम)', gender: 'male', subtitle: 'तंजौर नरेश', parent: 'ekoji_i', mother: 'dipabai_tanjore', yug: 'kali', kali_year: 4830, parichay: 'शासनकाल: 1728-1736 ई.। एकोजी प्रथम के तीसरे पुत्र।', clusterName: 'तंजौर (मराठा) वंश' },
    ...
    { id: 'pratap_singh_tanjore', name: 'प्रताप सिंह (तंजौर)', gender: 'male', subtitle: 'तंजौर नरेश', parent: 'tukkoji_tanjore', mother: 'annapurna_tanjore', yug: 'kali', kali_year: 4841, parichay: 'शासनकाल: 1739-1763 ई.।', clusterName: 'तंजौर (मराठा) वंश' },
    { id: 'thuljaji_tanjore', name: 'तुलजाजी (द्वितीय)', gender: 'male', subtitle: 'तंजौर नरेश', parent: 'pratap_singh_tanjore', yug: 'kali', kali_year: 4865, parichay: 'शासनकाल: 1763-1787 ई. (जन्म: 1738 - मृत्यु: 1787)। विद्या और कला के महान संरक्षक।', clusterName: 'तंजौर (मराठा) वंश' },
    { id: 'amar_singh_tanjore', name: 'अमर सिंह (तंजौर)', gender: 'male', subtitle: 'तंजौर नरेश (प्रतिशासक)', parent: 'pratap_singh_tanjore', yug: 'kali', kali_year: 4889, parichay: 'शासनकाल: 1787-1798 ई.। तुलजाजी के सौतेले भाई और सरफोजी द्वितीय के रीजेंट/अзуर्पर (usurper)।', clusterName: 'तंजौर (मराठा) वंश' },
    ...
    { id: 'shivaji_tanjore', name: 'शिवाजी (तंजौर)', gender: 'male', subtitle: 'अंतिम तंजौर नरेश', parent: 'serfoji_ii_tanjore', mother: 'avubai_tanjore', yug: 'kali', kali_year: 4934, parichay: 'शासनकाल: 1832-1855 ई.। इनकी मृत्यु के बाद अंग्रेजों ने "Doctrine of Lapse" के तहत राज्य हड़प लिया।', clusterName: 'तंजौर (मराठा) वंश' },
